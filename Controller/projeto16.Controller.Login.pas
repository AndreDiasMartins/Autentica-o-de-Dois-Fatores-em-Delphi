...
function TLoginController.OpenUser(var Query: TFDMemTable; Login: String; Password: String; out StrErr: string): Boolean;
begin
  Result := FLoginDAO.OpenUser(Query, Login, Password, StrErr);
end;
...
function TLoginController.ValidEmail(var Query: TFDMemTable; AParams: array of variant; out StrErr: string): Boolean;
begin
  Result := FLoginDAO.ValidEmail(Query, AParams, StrErr);
end;
