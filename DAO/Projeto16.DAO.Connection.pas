...
type
  TDAO = class(TDataModule)
    ...
    FDValidEmailDIsp: TFDQuery;
    FDValidEmailDIspid: TIntegerField;
    FDValidEmailDIspemail: TWideStringField;
    FDValidEmailLogin: TFDQuery;
    FDValidEmailLoginid: TIntegerField;
    FDValidEmailLoginlogin: TWideStringField;
  strict private
